...
function getRow () {
    return `${faker.name.findName()}, ${faker.random.number(100)}, ${faker.random.number(80)}, ${faker.phone.phoneNumberFormat(1)}, ${faker.image.avatar()}\n`;
}

function writeRows (writer) {
    let numberOfRows = 10000000;
    function writing () {
        let flowing = true;
        do {
            numberOfRows--;
